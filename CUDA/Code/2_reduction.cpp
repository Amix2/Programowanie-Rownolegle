...
// Program main
////////////////////////////////////////////////////////////////////////////////
int mainWarmDivergence(int argc, char *argv[])
{
    float *h_inPtr;
    ...
    run_benchmark(reductionSequential, d_outPtr, d_inPtr, size);
    run_benchmark(reductionInterleaving, d_outPtr, d_inPtr, size);
